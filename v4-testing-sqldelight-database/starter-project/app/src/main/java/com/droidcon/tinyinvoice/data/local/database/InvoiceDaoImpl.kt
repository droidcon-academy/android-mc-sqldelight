...
import com.droidcon.tinyinvoice.data.local.mapper.toInvoice
import com.droidcon.tinyinvoice.data.local.mapper.toInvoiceItem
...
class InvoiceDaoImpl @Inject constructor(
    ...
    override fun lastInsertRowId() = invoiceQueries.lastInsertRowId().executeAsOne()
